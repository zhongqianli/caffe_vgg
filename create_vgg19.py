...
def create_vgg19(input_shape, classes=1000, deploy=False):
    net_name = "vgg19"
    ...
    net.block3_conv4 = L.Convolution(net.block3_relu3, kernel_size=3, num_output=256, pad=1,
                                     weight_filler=dict(type="xavier"),
                                     bias_filler=dict(type="constant", value=0),
                                     param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    net.block3_relu4 = L.ReLU(net.block3_conv4, in_place=True)
    net.block3_pool = L.Pooling(net.block3_relu4, kernel_size=2, stride=2, pool=P.Pooling.MAX)
    ...
    net.block4_conv4 = L.Convolution(net.block4_relu3, kernel_size=3, num_output=512, pad=1,
                                     weight_filler=dict(type="xavier"),
                                     bias_filler=dict(type="constant", value=0),
                                     param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    net.block4_relu4 = L.ReLU(net.block4_conv4, in_place=True)
    net.block4_pool = L.Pooling(net.block4_relu4, kernel_size=2, stride=2, pool=P.Pooling.MAX)
    ...
    net.block5_conv4 = L.Convolution(net.block5_relu3, kernel_size=3, num_output=512, pad=1,
                                     weight_filler=dict(type="xavier"),
                                     bias_filler=dict(type="constant", value=0),
                                     param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    net.block5_relu4 = L.ReLU(net.block5_conv4, in_place=True)
    net.block5_pool = L.Pooling(net.block5_relu4, kernel_size=2, stride=2, pool=P.Pooling.MAX)
...
if __name__ == "__main__":
    ...
    create_vgg19(input_shape=input_shape, classes=classes, deploy=False)
    create_vgg19(input_shape=input_shape, classes=classes, deploy=True)
